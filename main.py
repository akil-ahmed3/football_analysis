...
from assigner import TeamAssigner, PlayerBallAssigner
...
def main():
    ...
    tracks = tracker.get_object_tracks(video_frames, read_from_file=True, save_path='saved/tracks_saved.pkl')
    ...
    camera_movement_per_frame = camera_movement.get_camera_movement(
        ...
        cache_path='saved/camera_movement_cache.pkl')
    ...
    speed_and_dist_estimator = SpeedAndDistance_Estimator()
    speed_and_dist_estimator.add_speed_and_distance_to_tracks(tracks)
    ...
    speed_and_dist_estimator.draw_speed_and_distance(output_video_frames, tracks)
